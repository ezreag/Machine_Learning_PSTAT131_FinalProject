...
Now that we've trained our model on the training data and calculated our performance metric scores, along with other metrics of our estimator, let's see how well our model did!  
...
```{python time_it=TRUE}
svr_model_estimators = []
svr_model_estimators.append(('standardize', StandardScaler()))
svr_model_estimators.append(('LinearSVR', LinearSVR()))
svr_model = Pipeline(svr_model_estimators)
svr_model
```
