...
```{python}
sandiego_46047_df.corr(numeric_only=True)
corrplot = sb.heatmap(sandiego_46047_df.corr(numeric_only=True))
plt.show()
```
...
```{python class.source="fold-show", cache=TRUE, eval=FALSE}
...
# |_____________________|___________|___________|___________|___________|____________|
```

## "Gives a Pressing Knit Phobia"
...
## "Was in the Final Submission I Guess"
...
![:o](131_Project_Images/suspense_stock_pic.jpg){width=100%}
...
![Figure 4: Black's Beach, San Diego (Winter 2020)](131_Project_Images/ezra.jpg){width=100%}